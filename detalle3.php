...
<body data-spy="scroll" data-target="#navbar-example">
                 ...
                 <div class="col-md-4 col-sm-4 col-xs-12 development">
                    <div class="single-awesome-project">
                        <div class="awesome-img">
                            <a href="principal.html"><img src="assets/img/portfolio/3.png" alt="" /></a>
                            <div class="add-actions text-center">
                                <div class="project-dec">
                                    <a class="venobox" data-gall="myGallery" href="principal.html">
                                        <h4>RX 580 PULSE</h4>
                                        <span>Sapphire 8GB 256-bit GDDR5, PCI Express x16 2.0</span>
                                    </a>
                                </div>
                            </div>
                        </div>
   ...
   print("idPro:  " . $temp[5]['nombre_producto'] . '<br>');
   print("Nombre: " . $temp[5]['descripcion_producto'] . '<br>');
   print("Precio_Venta: " . $temp[5]['precio_venta'] . '<br>');
