  ...
  <div class="col-md-4 col-sm-4 col-xs-12 photo">
    <div class="single-awesome-project">
        <div class="awesome-img">
            <a href="principal.html"><img src="assets/img/portfolio/8.png" alt="" /></a>
            <div class="add-actions text-center">
                <div class="project-dec">
                    <a class="venobox" data-gall="myGallery" href="principal.html">
                        <h4>MOBO ASUS ATX ROG STRIX B550-F GAMING</h4>
                        <span>S-AM4, AMD B550, HDMI, 128GB DDR4 para AMD</span>
                    </a>
                </div>
            </div>
        </div>
...
<?php
   ...
   print("idPro:  " . $temp[3]['nombre_producto'] . '<br>');
   print("Nombre: " . $temp[3]['descripcion_producto'] . '<br>');
   print("Precio_Venta: " . $temp[3]['precio_venta'] . '<br>');
