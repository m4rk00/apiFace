            ...
            <div class="col-md-4 col-sm-4 col-xs-12 design">
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        <a href="principal.html"><img src="assets/img/portfolio/5.png" alt="" /></a>
                        <div class="add-actions text-center text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery" href="principal.html">
                                    <h4>XPG SPECTRIX D60G</h4>
                                    <span>DDR4, 3200MHz, 8GB, Non-ECC, CL16, XMP</span>
                                </a>
                            </div>
                        </div>
                    </div>
...
print("idPro:  " . $temp[7]['nombre_producto'] . '<br>');
print("Nombre: " . $temp[7]['descripcion_producto'] . '<br>');
print("Precio_Venta: " . $temp[7]['precio_venta'] . '<br>');
