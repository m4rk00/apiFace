...
<body data-spy="scroll" data-target="#navbar-example">
             ...
             <div class="col-md-4 col-sm-4 col-xs-12 design">
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        <a href="principal.html"><img src="assets/img/portfolio/6.png" alt="" /></a>
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery" href="principal.html">
                                    <h4>Kit Memoria RAM Corsair Vengeance RGB PRO</h4>
                                    <span>DDR4, 3000MHz, 16GB (2 x 8GB), Non-ECC, CL15</span>
                                </a>
                            </div>
                        </div>
                    </div>
   ...
   print("idPro:  " . $temp[2]['nombre_producto'] . '<br>');
   print("Nombre: " . $temp[2]['descripcion_producto'] . '<br>');
   print("Precio_Venta: " . $temp[2]['precio_venta'] . '<br>');
