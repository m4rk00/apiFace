...
<body data-spy="scroll" data-target="#navbar-example">
                   ...
                   <div class="col-md-4 col-sm-4 col-xs-12 development">
                    <div class="single-awesome-project">
                        <div class="awesome-img">
                            <a href="principal.html"><img src="assets/img/portfolio/2.png" alt="" /></a>
                            <div class="add-actions text-center">
                                <div class="project-dec">
                                    <a class="venobox" data-gall="myGallery" href="principal.html">
                                        <h4>RX 5600 XT BE</h4>
                                        <span>TSapphire Pulse, 6GB 192-bit GDDR6, PCI Express 4.0</span>
                                    </a>
                                </div>
                            </div>
                        </div>
   ...
   print("idPro:  " . $temp[4]['nombre_producto'] . '<br>');
   print("Nombre: " . $temp[4]['descripcion_producto'] . '<br>');
   print("Precio_Venta: " . $temp[4]['precio_venta'] . '<br>');
