...
<body data-spy="scroll" data-target="#navbar-example">
              ...
              <div class="col-md-4 col-sm-4 col-xs-12 photo">
                <div class="single-awesome-project">
                    <div class="awesome-img">
                        <a href="principal.html"><img src="assets/img/portfolio/7.png" alt="" /></a>
                        <div class="add-actions text-center">
                            <div class="project-dec">
                                <a class="venobox" data-gall="myGallery" href="principal.html">
                                    <h4>MOBO Gigabyte micro ATX B460M DS3H</h4>
                                    <span>S-1200, Intel B460, HDMI, 128GB DDR4 para Intel</span>
                                </a>
                            </div>
                        </div>
                    </div>
   ...
   print("idPro:  " . $temp[8]['nombre_producto'] . '<br>');
   print("Nombre: " . $temp[8]['descripcion_producto'] . '<br>');
   print("Precio_Venta: " . $temp[8]['precio_venta'] . '<br>');
